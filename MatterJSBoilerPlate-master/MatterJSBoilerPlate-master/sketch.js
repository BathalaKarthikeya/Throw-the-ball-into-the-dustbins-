...
function draw() {
  ...
  textSize(18);
  fill("blue")
  text("'We should always throw Biodegradable waste into the recycle dustbin'. So clean your room by throwing the crumpled paper into the recycle dustbin. PRESS 'UP ARROW TO DO THIS'.",50,100);
}
